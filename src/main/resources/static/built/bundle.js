...
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/userList'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return React.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module './components/userList'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
